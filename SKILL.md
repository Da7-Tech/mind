...
- `python3` (3.9+) and `curl` on PATH — nothing else: no API keys, no
  ...
  from https://github.com/Da7-Tech/mind (94 tests + benchmark + 180-day
...
```bash
cd <project>
curl -fsSLO https://raw.githubusercontent.com/Da7-Tech/mind/v5.4.2/mind.py
echo "dbd6489c9f5db61c0228534bea005d4499dd81535f35d9794146e7b84f923395  mind.py" | shasum -a 256 -c
...
```bash
cd "$(mktemp -d)" && curl -fsSLO https://raw.githubusercontent.com/Da7-Tech/mind/v5.4.2/mind.py && python3 mind.py init >/dev/null && python3 mind.py remember "the sky signal is 7413" >/dev/null && python3 mind.py recall "sky signal"
```
